...
model = YoloDetector(model_path="./best_float32.tflite", device="cpu")
...
with Picamera2(resolution=(640, 640)) as camera:
    camera.create_preview_configuration()
    camera.start()
    while True:
        capture = camera.capture_array(camera)
